...
public class GangesOrderShipper {
    ...
    public static void main(String[] args) {
        ...
        Book b1 = new StandardSizeBook("The Unbearable Lightness of Being John Malkovich", 19.95, MAX_EXPECTED_SHIPPING);
        Book b2 = new OversizedBook("The Princess Brideshead Revisited", 29.15, MAX_EXPECTED_SHIPPING);
        ...
        for (Book b : booksToShip) {
            ...
            System.out.printf("The book %s is being shipped for %.2f in a %s-sized box.\n",
                    thisTitle, shipping, b.getMinBoxSize());
